...
import { LABEL as UI_LABEL } from '@/features/ui/styles';
...
export const BUTTON = buttonVariants({ variant: 'primary', size: 'compact' });
export const BUTTON_QUIET = buttonVariants({ variant: 'secondary', size: 'compact' });
